...
class XTransMAC:
    def __init__(self, scheme, groups, args):
        ...
        self.prior_repre = th.zeros(self.n_agents, args.task_repre_dim, requires_grad=True) 
    ...
    def get_task_repres(self, require_grad=True):
        # zero_shot
        if not getattr(self.args, "few_shot_adaptation", False):
            return self.prior_repre.to(self.args.device)
